package com.ekocbiyik.demo.thirdpart.wagu;
...
public class Bill {
    ...
    public static void main(String[] args) {
        String company = "SHOPPING DETAILS";
        ...
        b.setInitialBlock(new Block(b, 46, 1, company).allowGrid(true).setBlockAlign(Block.BLOCK_CENTRE).setDataAlign(Block.DATA_CENTER));
